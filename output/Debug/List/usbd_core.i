#line 1 "E:\\work\\GitHub\\Template_For_uCOS-II\\Software\\USBStack\\src\\usbd_core.c"
...
#line 18 "E:\\work\\GitHub\\Template_For_uCOS-II\\Software\\USBStack\\src\\usbd_core.c"
 ...
 * Consult your license regarding permissions and restrictions.
V5.04:0576 */
#line 19 "E:\\work\\GitHub\\Template_For_uCOS-II\\Software\\USBStack\\src\\usbd_core.c"
...
#line 20 "E:\\work\\GitHub\\Template_For_uCOS-II\\Software\\USBStack\\src\\usbd_core.c"
//#include "version.h"
...
BOOL USBD_ReqSetClrFeature (U32 sc) {
  ...
  switch (USBD_SetupPacket.bmRequestType.Recipient) {
    case 0:
      if (USBD_SetupPacket.wValue == 1) {
        if (sc) {
          USBD_WakeUpCfg(1);
          USBD_DeviceStatus |=  0x02;
        } else {
          USBD_WakeUpCfg(0);
          USBD_DeviceStatus &= ~0x02;
        }
  ...
  switch (USBD_SetupPacket.bmRequestType.Recipient) {
    case 0:
      switch (USBD_SetupPacket.wValueH) {
        ...
        case 6:
          if (!usbd_hs_enable) {
            return (0);  /* High speed not enabled */
          }
          if (USBD_HighSpeed == 0) {
          ...
          break;
        case 2:
          if ((!usbd_hs_enable) && (USBD_HighSpeed == 1)) {
            return (0);  /* High speed request but high-speed not enabled */
          }
          if (USBD_HighSpeed == 0) {
...
BOOL USBD_ReqSetInterface (void) {
  ...
  switch (USBD_SetupPacket.bmRequestType.Recipient) {
    case 1:
      if (USBD_Configuration == 0) return (0);
      set = 0;
      if ((!usbd_hs_enable) && (USBD_HighSpeed == 1)) {
        return (0);  /* High speed request but high-speed not enabled */
      }
      ...
      case 0:
        switch (USBD_SetupPacket.bRequest) {
          ...
          case 1:
            ...
            USBD_StatusInStage();
#line 649 "E:\\work\\GitHub\\Template_For_uCOS-II\\Software\\USBStack\\src\\usbd_core.c"
          ...
          case 3:
            ...
            USBD_StatusInStage();
#line 669 "E:\\work\\GitHub\\Template_For_uCOS-II\\Software\\USBStack\\src\\usbd_core.c"
              if (USBD_P_Feature_Event) {
                USBD_P_Feature_Event();
              }
          ...
          case 9:
            ...
            USBD_StatusInStage();
#line 714 "E:\\work\\GitHub\\Template_For_uCOS-II\\Software\\USBStack\\src\\usbd_core.c"
          ...
          case 11:
            ...
            USBD_StatusInStage();
#line 741 "E:\\work\\GitHub\\Template_For_uCOS-II\\Software\\USBStack\\src\\usbd_core.c"
...
setup_class_ok:                                                          /* request finished successfully */
      ...
      default:
stall:  if ((USBD_SetupPacket.bmRequestType.Dir == 0) &&
  ...
  if (event & (1 << 2)) {
    if (USBD_SetupPacket.bmRequestType.Dir == 0) {
...
stall_i:      USBD_SetStallEP(0x80);
  ...
  if (event & (1 << 3)) {
    if (USBD_SetupPacket.bmRequestType.Dir == 1) {
