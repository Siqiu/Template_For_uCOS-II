#line 1 "E:\\work\\GitHub\\Template_For_uCOS-II\\Software\\uCOS-II\\port\\os_dbg.c"
/*
*********************************************************************************************************
*                                                uC/OS-II
...
#line 25 "E:\\work\\GitHub\\Template_For_uCOS-II\\Software\\uCOS-II\\port\\os_dbg.c"
...
INT16U  const  OSDebugEn           = 1;               /* Debug constants are defined below   */
...
INT16U  const  OSEventMax          = 10u;             /* Number of event control blocks      */
...
INT16U  const  OSMemMax            = 5u;           /* Number of memory partitions         */
INT16U  const  OSMemNameEn         = 6u;
...
INT16U  const  OSQMax              = 4u;                 /* Number of queues                    */
...
INT16U  const  OSRdyTblSize        = ((63u) / 8u + 1u);           /* Number of bytes in the ready table  */
...
INT16U  const  OSTaskMax           = 20u + 2u; /* Total max. number of tasks      */
INT16U  const  OSTaskNameEn        = 1u;  
INT16U  const  OSTaskStatEn        = 1;
...
#line 132 "E:\\work\\GitHub\\Template_For_uCOS-II\\Software\\uCOS-II\\port\\os_dbg.c"
