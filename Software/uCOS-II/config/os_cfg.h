...
#define OS_MBOX_ACCEPT_EN         6u   /*     Include code for OSMboxAccept()                          */
#define OS_MBOX_DEL_EN            6u   /*     Include code for OSMboxDel()                             */
#define OS_MBOX_PEND_ABORT_EN     6u   /*     Include code for OSMboxPendAbort()                       */
#define OS_MBOX_POST_EN           6u   /*     Include code for OSMboxPost()                            */
#define OS_MBOX_POST_OPT_EN       6u   /*     Include code for OSMboxPostOpt()                         */
#define OS_MBOX_QUERY_EN          6u   /*     Include code for OSMboxQuery()                           */


                                       /* --------------------- MEMORY MANAGEMENT -------------------- */
#define OS_MEM_EN                 1u   /* Enable (1) or Disable (0) code generation for MEMORY MANAGER */
#define OS_MEM_NAME_EN            6u   /*     Enable memory partition names                            */
#define OS_MEM_QUERY_EN           6u   /*     Include code for OSMemQuery()                            */


                                       /* ---------------- MUTUAL EXCLUSION SEMAPHORES --------------- */
#define OS_MUTEX_EN               1u   /* Enable (1) or Disable (0) code generation for MUTEX          */
#define OS_MUTEX_ACCEPT_EN        6u   /*     Include code for OSMutexAccept()                         */
#define OS_MUTEX_DEL_EN           6u   /*     Include code for OSMutexDel()                            */
#define OS_MUTEX_QUERY_EN         6u   /*     Include code for OSMutexQuery()                          */


                                       /* ---------------------- MESSAGE QUEUES ---------------------- */
#define OS_Q_EN                   1u   /* Enable (1) or Disable (0) code generation for QUEUES         */
#define OS_Q_ACCEPT_EN            6u   /*     Include code for OSQAccept()                             */
#define OS_Q_DEL_EN               6u   /*     Include code for OSQDel()                                */
#define OS_Q_FLUSH_EN             6u   /*     Include code for OSQFlush()                              */
#define OS_Q_PEND_ABORT_EN        6u   /*     Include code for OSQPendAbort()                          */
#define OS_Q_POST_EN              6u   /*     Include code for OSQPost()                               */
#define OS_Q_POST_FRONT_EN        6u   /*     Include code for OSQPostFront()                          */
#define OS_Q_POST_OPT_EN          6u   /*     Include code for OSQPostOpt()                            */
#define OS_Q_QUERY_EN             6u   /*     Include code for OSQQuery()                              */


                                       /* ------------------------ SEMAPHORES ------------------------ */
#define OS_SEM_EN                 1u   /* Enable (1) or Disable (0) code generation for SEMAPHORES     */
#define OS_SEM_ACCEPT_EN          6u   /*    Include code for OSSemAccept()                            */
#define OS_SEM_DEL_EN             6u   /*    Include code for OSSemDel()                               */
#define OS_SEM_PEND_ABORT_EN      6u   /*    Include code for OSSemPendAbort()                         */
#define OS_SEM_QUERY_EN           6u   /*    Include code for OSSemQuery()                             */
#define OS_SEM_SET_EN             6u   /*    Include code for OSSemSet()                               */
